...
import { markMonthlyFeePaid, markMonthlyFeeUnpaid, getCourseMonthlyFeesByYear, initMonthlyFeeForYear } from "../controllers/admin.monthlyFee.controller.js";
...
router.post("/init-year", authorizedRoles("admin"), initMonthlyFeeForYear);
