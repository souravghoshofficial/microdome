  ...
  return (
    <div className="w-full h-screen overflow-y-scroll scrollbar-none relative bg-white dark:bg-gray-950 text-black dark:text-white transition-colors duration-300 ">
      ...
      <div
        ...
        className="h-12 z-10  md:h-14  bg-[#2DD54D] rounded-full fixed bottom-5 right-8 text-white flex items-center justify-center cursor-pointer border-b-4 border-indigo-500">
