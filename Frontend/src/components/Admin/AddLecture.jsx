  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 relative">
      ...
      <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {courses.map((course) => (
          <div key={course._id} className="bg-white rounded-xl shadow-md p-4 text-center">
            <img src={course.courseImage} alt={course.courseTitle} className="h-40 w-full object-cover rounded-md" />
      ...
      {selectedCourse && !selectedSection && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-40 backdrop-blur-sm flex items-center justify-center">
          <div className="bg-white rounded-lg shadow-md w-full max-w-md p-6">
            <h2 className="text-xl font-bold text-center mb-4 text-blue-700">Select Section</h2>
            <ul className="space-y-3">
              {sections.map(section => (
                <li key={section._id} className="flex justify-between items-center border-b pb-2">
      ...
      {selectedSection && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-40 backdrop-blur-sm flex items-center justify-center">
          <div className="bg-white rounded-lg shadow-md w-full max-w-md p-6">
            <h2 className="text-xl font-bold mb-4 text-center text-blue-700">Add Lecture</h2>
