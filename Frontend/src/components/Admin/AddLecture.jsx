...
const AddLecture = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(`${ApiUrl}/courses/add-lecture`, data, {
        withCredentials: true,
      });
  ...
  return (
    <div className="bg-gray-100 relative min-h-screen p-6">
          ...
          <div className="bg-white rounded-lg shadow-md w-full max-w-md p-6">
            ...
            <ul className="space-y-3 max-h-60 overflow-y-auto">
              {sections.length > 0 ? (
                ...
                <p className="text-gray-500 text-center">No sections found.</p>
              )}
            </ul>
            <button
              onClick={resetForm}
