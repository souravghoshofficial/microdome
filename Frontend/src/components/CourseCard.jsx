...
const CourseCard = ({
  ...
  return (
    <Link to={linkAddress} className="w-full cursor-pointer hover:-translate-y-3 transition-all duration-300 flex flex-col overflow-hidden text-black dark:bg-zinc-900 dark:text-white rounded-xl dark:border dark:border-gray-700/25 bg-white shadow-lg shadow-gray-300 dark:shadow-[0_4px_12px_rgba(0,0,0,0.6)_0_1px_3px_rgba(255,255,255,0.05)]">
      <div className="w-full relative">
        ...
        <img className="w-full h-72 object-cover object-center" src={courseImg} alt="course image" />
      </div>
