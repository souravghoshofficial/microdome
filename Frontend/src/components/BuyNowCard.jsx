...
const BuyNowCard = ({actualPrice , discountedPrice = actualPrice , handlePayment}) => {
  ...
  return (
    <div className='w-full bg-white dark:bg-zinc-900 text-black dark:text-white border border-zinc-900/10 dark:border-gray-700/25 rounded-lg overflow-hidden shadow-lg shadow-gray-300 dark:shadow-[0_4px_12px_rgba(0,0,0,0.6)_0_1px_3px_rgba(255,255,255,0.05)]'>
       ...
       <div className='w-full px-4 py-6'>
         ...
         <button onClick={() => handlePayment()} className='w-full mt-4 py-2 font-semibold rounded-md cursor-pointer bg-blue-600 hover:bg-blue-700 transition-colors duration-300 text-white text-center'>Enroll Now</button>
