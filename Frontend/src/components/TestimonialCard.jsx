...
const TestimonialCard = ({ name, message, imageUrl, designation }) => {
  return (
    <div className="p-5 rounded-xl border cursor-pointer border-gray-950/[.1] bg-gray-950/[.01] hover:bg-gray-950/[.05] dark:border-gray-50/[.1] dark:bg-gray-50/[.10] dark:hover:bg-gray-50/[.15] text-black dark:text-white ">
