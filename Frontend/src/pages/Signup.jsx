...
const Signup = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Signup | Microdome Classes</title>
        <meta
          name="description"
          content="Create your account on Microdome Classes to access a wide range of biology courses and resources."
        />
        <meta
          name="keywords"
          content="Microdome, Signup, Biology Courses, Online Learning, Education"
        />
