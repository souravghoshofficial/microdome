...
function QuestionResult({ q }) {
  ...
  return (
    <div className={`rounded-xl border p-5 mb-4 ${getStateClasses(q.resultState)}`}>
...
function NoAttempt({ testId, navigate, theme }) {
  return (
    <div className={`${theme === "dark" ? "dark" : ""} min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950`}>
...
export default function MockTestResult() {
  ...
  if (status === "loading") {
    return (
      <div className={`${theme === "dark" ? "dark" : ""} min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950`}>
        <div className="text-gray-600 dark:text-gray-400">Loading result...</div>
      </div>
    );
  }
  ...
  if (status === "locked") {
    return (
      <div className={`${theme === "dark" ? "dark" : ""} min-h-screen bg-gray-50 dark:bg-gray-950`}>
        <div className="max-w-6xl mx-auto px-4 py-10">
          <TestHeader mockTest={mockTest} attemptNumber={data.attempt?.attemptNumber} />
          <LockedBanner />
