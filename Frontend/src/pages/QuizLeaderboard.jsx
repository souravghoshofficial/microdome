  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-zinc-950 text-gray-800 dark:text-white py-10">
      <div className="w-[95%] lg:w-[80%] mx-auto bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-lg">
        ...
        <div className="flex justify-center items-end gap-6 mb-12">
          ...
          {topThree[1] && (
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm text-gray-500">Score: {topThree[1].score}</span>
              <div className="bg-gray-400 w-16 h-24 mt-2 rounded-t-lg flex items-center justify-center text-white font-bold">2</div>
            </div>
          )}
          ...
          {topThree[0] && (
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm text-gray-500">Score: {topThree[0].score}</span>
              <div className="bg-yellow-500 w-16 h-32 mt-2 rounded-t-lg flex items-center justify-center text-white font-bold">1</div>
            </div>
          )}
          ...
          {topThree[2] && (
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm text-gray-500">Score: {topThree[2].score}</span>
              <div className="bg-orange-500 w-16 h-20 mt-2 rounded-t-lg flex items-center justify-center text-white font-bold">3</div>
            </div>
          )}
        </div>
        ...
        {/* Others */}
        <div className="mt-6">
          <h2 className="text-xl font-bold mb-4">Other Participants</h2>
          <div className="bg-gray-100 dark:bg-zinc-800 rounded-lg overflow-hidden">
            {others.length === 0 ? (
              <p className="p-4 text-center text-gray-600">No more participants</p>
            ) : (
