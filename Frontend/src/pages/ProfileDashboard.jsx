...
import { RiGraduationCapLine , RiMailLine , RiMapPinLine } from "@remixicon/react"
  ...
  return (
    <div className="w-full pt-24 flex items-center justify-center">
        <div className='w-[90%] flex flex-col md:flex-row gap-8 lg:gap-0'>
            <div className='w-full lg:w-[25%] h-screen px-4 py-6 border border-gray-950/[.1] dark:border-gray-50/[.1]'>
                ...
                <div>
                  ...
                  <div className='mt-3 flex items-center gap-2'>
                    ...
                    <p className='text-sm'>{userData?.institute || "-"}</p>
                  </div>
                  <div className='mt-3 flex items-center gap-2'>
            ...
            <div className='w-full lg:w-[75%] h-screen px-4 py-6 border border-gray-950/[.1] dark:border-gray-50/[.1]  lg:border-l-0'> </div>
        </div>
    </div>
  )
}
