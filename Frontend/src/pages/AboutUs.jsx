      ...
      <div className="max-w-4xl mx-auto text-center space-y-16">
        ...
        <div className="w-full">
          <img
            ...
            className="rounded-2xl shadow-lg mx-auto w-full max-w-2xl object-contain transition-transform duration-300 hover:scale-105"
          />
        </div>
