...
const Enroll = () => {
  ...
  return (
    <div className="my-16 w-full flex items-center justify-center">
      <div className="w-[90%]">
        <h4
          className="text-center text-sm font-semibold text-gray-400 dark:text-gray-500"
          data-aos="fade-up"
        >
          Enroll
        </h4>
        <h2
          className="mt-2 text-3xl md:text-4xl text-center font-bold"
          data-aos="fade-up"
          data-aos-delay="150"
        >
        ...
        <div className="mt-12 flex flex-col md:flex-row gap-6">
          ...
          >
            ...
            <div className="mt-4 flex gap-3">
              <Link
                to="signup"
                className="px-4 py-2 border border-gray-400 dark:border-gray-600 rounded-md text-sm hover:bg-gray-100 dark:hover:bg-gray-800"
              >
                Signup
              </Link>
              <Link
                to="courses"
                className="px-4 py-2 rounded-md text-sm border border-highlighted bg-highlighted hover:bg-highlighted-hover hover:border-highlighted-hover text-white"
              >
                Enroll
              </Link>
            </div>
